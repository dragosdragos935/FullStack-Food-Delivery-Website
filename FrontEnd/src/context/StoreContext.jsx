  ...
  const fetchFoodList = async () => {
    try {
      ...
      if (response.data.success) {
        // Procesăm fiecare produs pentru a ne asigura că toate câmpurile sunt disponibile
        const processedFoodList = response.data.data.map(food => ({
          ...food,
